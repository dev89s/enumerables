...
# 📖 My Enumerable Project Project <a id="about-project"></a>

**My Enumerable Project** is a project that showcases a class of list of items that uses a module to make the list items enumerable with `all?`, `any?`, and `filter` capabilities.
...
```sh
  cd my-folder
  git clone https://github.com/dev89s/enumerables.git
```
